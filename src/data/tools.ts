...
export const tools: Tool[] = [
  ...
  // INTERNATIONAL/UNIVERSAL TOOLS
  {
    slug: "invoice-generator-global",
    title: "Invoice Generator (International)",
    category: "business",
    icon: "Receipt",
    shortDesc: "Create professional invoices with multi-currency and VAT support",
    longDesc: "Generate professional invoices for clients worldwide. Supports multiple currencies (USD, EUR, GBP, etc.), VAT/Sales Tax calculations, and international date formats.",
    popular: true,
    faqs: [
      { q: "What currencies are supported?", a: "USD, EUR, GBP, CAD, AUD, JPY, and many more." },
      { q: "Does it support VAT?", a: "Yes, with customizable VAT/Sales Tax rates for any country." },
    ],
    howToSteps: [
    ...
    relatedSlugs: ["invoice-generator", "vat-calculator", "percentage-calculator", "quotation-maker", "currency-converter"],
  },
  {
    slug: "vat-calculator",
    ...
    category: "business",
    icon: "Percent",
    shortDesc: "Calculate VAT or Sales Tax for any country",
    longDesc: "Universal tax calculator supporting VAT (Europe, UK), Sales Tax (US), and other tax systems worldwide. Add or remove tax from any amount.",
    faqs: [{ q: "What tax rates are supported?", a: "Any rate from 0-100%. Common presets for US, UK, EU, Canada, Australia included." }],
    howToSteps: ["Enter amount", "Select or enter tax rate", "Choose add or remove tax", "View breakdown"],
    relatedSlugs: ["invoice-generator-global", "percentage-calculator", "gst-calculator", "tip-calculator", "currency-converter"],
  },
  {
    slug: "salary-calculator-global",
    title: "Salary Calculator (International)",
    category: "calculators",
    icon: "DollarSign",
    shortDesc: "Calculate take-home salary for multiple countries",
    longDesc: "Estimate your net salary after taxes and deductions. Supports US, UK, Canada, Australia, Germany, and more with country-specific tax brackets.",
    faqs: [{ q: "Which countries are supported?", a: "US, UK, Canada, Australia, Germany, France, and more." }],
    howToSteps: ["Select country", "Enter gross salary", "Add deductions if applicable", "View net salary breakdown"],
    relatedSlugs: ["salary-calculator", "vat-calculator", "percentage-calculator", "currency-converter", "emi-calculator"],
  },
  {
    ...
    category: "utilities",
    icon: "ArrowLeftRight",
    shortDesc: "Convert between world currencies instantly",
    longDesc: "Convert amounts between 150+ world currencies with up-to-date exchange rates. Perfect for international business and travel.",
    faqs: [{ q: "Are rates live?", a: "Rates are updated regularly but may have slight delays." }],
    howToSteps: ["Enter amount", "Select source currency", "Select target currency", "View converted amount"],
    relatedSlugs: ["vat-calculator", "invoice-generator-global", "percentage-calculator", "tip-calculator", "unit-converter"],
  },
  {
    slug: "tip-calculator",
    ...
    category: "calculators",
    icon: "Wallet",
    shortDesc: "Calculate tips and split bills easily",
    longDesc: "Calculate tips based on service quality and split bills among friends. Supports custom tip percentages and rounding options.",
    faqs: [{ q: "What tip percentages are common?", a: "15% for average, 18% for good, 20%+ for excellent service in the US." }],
    howToSteps: ["Enter bill amount", "Select tip percentage", "Choose number of people", "View split amounts"],
    relatedSlugs: ["percentage-calculator", "currency-converter", "vat-calculator", "emi-calculator", "age-calculator"],
  },
];
